...
export class UserResolver {// The UserResolver class is responsible for handling GraphQL mutations related to the User entity
  ...
  async createUser(@Args("createUserInput") createUserInput: CreateUserInput){// The createUser method takes a CreateUserInput object as an argument, which contains the data for the new user
